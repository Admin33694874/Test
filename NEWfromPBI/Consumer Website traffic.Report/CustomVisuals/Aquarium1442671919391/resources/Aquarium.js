        ...
        (function (Aquarium1442671919391) {
            ...
            var Aquarium = (function () {
                ...
                Aquarium.prototype.init = function (options) {
                    ...
                    var svg = this.svg = d3.select(element.get(0)).append('svg').attr('style', 'background-color:#abcdef;').classed(Aquarium.VisualClassName, true);
                ...
                Aquarium.prototype.updateModel = function (dataView, colors) {
                    ...
                    if (dataView.metadata && dataView.metadata.objects) {
                        ...
                        var maxSize = powerbi.DataViewObjects.getValue(objects, { objectName: 'general', propertyName: 'maxSize' });
                        var triangleFish = powerbi.DataViewObjects.getValue(objects, { objectName: 'general', propertyName: 'triangleFish' });
                    }
                ...
                Aquarium.prototype.addOrUpdateFish = function (fishId, value, colour, tooltip, selector, fishType) {
                ...
                Aquarium.prototype.setTooltip = function (fishy) {
                    if (fishy == null) {
                ...
                Aquarium.prototype.drawFishy = function (fishy, scaleX, scaleY) {
                    ...
                    if (fishy.body == null) {
                        fishy.body = this.mainGroupElement.append('use').attr('xlink:href', '#' + fishy.svgShapeId).on('click', function () {
    ...
    (function (visuals) {
        ...
        (function (plugins) {
            plugins.Aquarium1442671919391 = {
                ...
                custom: true,
                create: function () { return new powerbi.visuals.Aquarium1442671919391.Aquarium(); }
            };
